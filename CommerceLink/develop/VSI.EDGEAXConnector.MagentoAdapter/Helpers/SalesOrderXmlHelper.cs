...
namespace VSI.EDGEAXConnector.MagentoAdapter.Helpers
{

    /// <summary>
    /// This class is helper class for sales order xml.
    /// </summary>
    public static class SalesOrderXmlHelper
    {
        /*
        public static List<EcomsalesOrderEntity> GetSalesOrderFromXML()
        {
            List<EcomsalesOrderEntity> salesOrders = new List<EcomsalesOrderEntity>();
            string ftpSourceDir = ConfigurationHelper.ECommerceSalesrOrderXMLPath; //FTP Path
            string localDir = ConfigurationHelper.ConnectorSalesrOrderXMLPath;
            SFTPlib.SFTPManager.DownloadDirectory(ftpSourceDir, localDir);
            //string[] files = Directory.GetFiles(localDir);
            //foreach (var file in files)
            //{
            //    MoveToLocalFolder(file, string.Empty);
            //}
            ...
            foreach (var localFile in localFiles)
            {
                ...
                salesOrder.Key = new Data.IntegrationKey()
                {
        ...
        */
        ...
        /// <returns></returns>
        public static EcomsalesOrderEntity GetSalesOrderFromXML(string localFile)
        {
            var doc = XElement.Load(localFile);
        ...
        public static void ConvertSalesOrderToXML(salesOrderEntity salesOrder)
        {
            if (salesOrder == null)
            {
                return;
        ...
        public static void MoveToLocalFolder(string file, string folder)
        {
