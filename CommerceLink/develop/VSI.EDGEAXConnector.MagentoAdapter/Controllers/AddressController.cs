...
namespace VSI.EDGEAXConnector.MagentoAdapter.Controllers
{
    ...
    /// <summary>
    /// AddressController Performs Address related activities on Magento side.
    /// </summary>
    public class AddressController : BaseController, IAddressController
    {
        ...
        /// </summary>
        public AddressController(string storeKey) : base(false, storeKey)
        {
        ...
        /// <returns></returns>
        private int CreateAddress(ECommerceDataModels.EcomcustomerAddressEntityItem address)
        {
            int id = 0;
            if (address != null)
            {
        ...
        /// <param name="address"></param>
        /// <returns></returns>
        private int UpdateAddress(ECommerceDataModels.EcomcustomerAddressEntityItem address)
        {
            int id = 0;
            if (address != null)
            {
        ...
        private customerAddressEntityCreate ConvertToEcomAddress(EcomcustomerAddressEntityItem address)
        {
            ...
            //add.suffix = address.suffix;
            //add.prefix = address.prefix;
            //add.region_id = address.region_id;
            //add.region_idSpecified = address.region_idSpecified;
