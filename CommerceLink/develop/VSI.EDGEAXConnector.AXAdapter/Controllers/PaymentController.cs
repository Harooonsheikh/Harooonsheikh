...
namespace VSI.EDGEAXConnector.AXAdapter.Controllers
{
    public class PaymentController : BaseController, IPaymentController
    {
        ...
        public string AuthorizeUsingTokenizedCard()
        {
            throw new NotImplementedException();
        }

        public ErpCardAuthorizeResponse AuthorizeUsingTokenizedCard(ErpCardAuthorizeRequest erpCardAuthRequest)
        {
            throw new NotImplementedException();
        }

        public string GenerateAuthBlob(ErpPaymentCard cardProperties, string authTransactionId, string approvalCode, decimal approvalAmount, DateTime transactionDate)
        {
            throw new NotImplementedException();
        }

        public string GenerateCardBlob(ErpPaymentCard cardProperties)
        {
            throw new NotImplementedException();
        }
...
//            tenderLines = Microsoft.Dynamics.Commerce.Runtime.Workflow.OrderWorkflowHelper.ProcessPendingOrderPayments(CommerceRuntimeHelper.RequestContext, CardTenderLineList);
        ...
        {
            var paymentCRTManager = new PaymentCRTManager();

            var erpPaymentConnectorResponse = paymentCRTManager.GetPaymentConnectorInfo(currentStore.StoreKey, requestId);
            return erpPaymentConnectorResponse;
        }
