...
update ConfigurableObject
set Description = 'EU2'
where ComValue in ('en_cr', 'es_cr', 'en_do', 'es_do', 'en_ec', 'en_pa', 'es_pa', 'en_pr', 'es_pr', 'en_uy ', 'en_ar', 'es_arp', 'en_us', 'es_us', 'en_ca', 'fr_ca', 'en_lat') and entitytype = 7;


-- 'BZS'
update ConfigurableObject
set Description = 'BZS'
where ComValue in ('es_ec','es_uy','es_ar','es_arp') and entitytype = 7;