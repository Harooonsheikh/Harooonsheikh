  ...
  <item repeat="true" data-source="ErpCatalog~Products" product-id="ErpProduct~ItemId" mode="ErpProduct~Mode">
    ...
    <cl_qty_single_qty_text expression="true">
		sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "cl_qty_single_qty_text").Value)
			? (sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "cl_qty_single_qty_text").Value == "NA" ? string.Empty : sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "cl_qty_single_qty_text").Value)
			: string.Empty
    ...
    <DisplayOnStoreWebsite expression="true">sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Display on Store Website").Value)
			? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Display on Store Website").Value
			: string.Empty</DisplayOnStoreWebsite>
    <product_name_cart expression="true">sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "product_name_cart").Value)
			? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "product_name_cart").Value
			: string.Empty</product_name_cart>
    <ConfirmationTemplate expression="true">sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Confirmation Template").Value)
			? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Confirmation Template").Value
			: string.Empty</ConfirmationTemplate>
