...
set [XML] = '<Items>
    ...
    <categories expression="true">sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Category_ids").Value) ? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Category_ids").Value : string.Empty</categories>
    <product_websites />
    <name expression="true">sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Ecom Product Name").Value) ? "&lt;![CDATA[" +sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Ecom Product Name").Value+ "]]&gt;": !string.IsNullOrWhiteSpace(sourceObject.ProductName) ? "&lt;![CDATA[" +sourceObject.ProductName+ "]]&gt;" : "&lt;![CDATA[" +sourceObject.Description+ "]]&gt;" </name>
    ...
    <default_unit_of_measure expression="true">sourceObject.Rules != null ? sourceObject.Rules.DefaultUnitOfMeasure : "pcs"</default_unit_of_measure>
    <tax_class_name expression="true">string.IsNullOrWhiteSpace(sourceObject.AvaTax_TaxClassId) ? "Taxable Goods" : sourceObject.AvaTax_TaxClassId</tax_class_name>
    ...
    <additional_attributes expression="true">sourceObject.IsMasterProduct ? "billing_intervals=Y,offer_types=SUB-Y" : "billing_intervals=" + sourceObject.ColorId + ",offer_types=" + sourceObject.StyleId</additional_attributes>
    <erp_attributes expression="true"> String.IsNullOrEmpty(sourceObject.Locale) ? ( sourceObject.CustomAttributes != null ? (string.Join(",", sourceObject.CustomAttributes.Select(att=&gt;att.Key + "=" +  (att.Value!=null? (att.Key == "mobile_description"? "&lt;![CDATA[" +att.Value+ "]]&gt;" :(att.Key == "plp_description"? "&lt;![CDATA[" +att.Value+ "]]&gt;" : (att.Key == "cart_description"? "&lt;![CDATA[" +att.Value+ "]]&gt;": (att.Key == "cl_config_body_content"? "&lt;![CDATA[" +att.Value+ "]]&gt;" : (att.Key == "cl_config_header_content"? "&lt;![CDATA[" +att.Value+ "]]&gt;"  : (att.Key == "Description"? "&lt;![CDATA[" +att.Value+ "]]&gt;" :att.Value)))))):string.Empty)))) : string.Empty ) : string.Empty </erp_attributes>
    ...
    <use_config_min_sale_qty expression="true">sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "min_sale_qty").Value) ? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "min_sale_qty").Value : string.Empty</use_config_min_sale_qty>
    <max_cart_qty>ErpProduct~HighestQty</max_cart_qty>
    <use_config_max_sale_qty expression="true">sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "max_sale_qty").Value) ? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "max_sale_qty").Value : string.Empty</use_config_max_sale_qty>
    ...
    <cl_qty_text expression="true">
    sourceObject.CustomAttributes != null &amp;&amp;!string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Quantity Text").Value)
    ? (sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Quantity Text").Value == "NA" ? string.Empty 			: sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Quantity Text").Value)
    : string.Empty
    </cl_qty_text>
    ...
    sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "cl_qty_single_qty_text1").Value)
    ? (sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "cl_qty_single_qty_text1").Value == "NA" ? string.Empty : sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "cl_qty_single_qty_text1").Value)
    : string.Empty
    ...
    <UseMainProductLicense expression="true">
    sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Use Main Product License").Value)
    ? (sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Use Main Product License").Value == "True" ? "Yes" : "No" )
    : string.Empty
    </UseMainProductLicense>
    <ProductLink expression="true">
    sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Product Link").Value)
    ? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Product Link").Value
    : string.Empty
    </ProductLink>
    <DisplayOnStoreWebsite expression="true">
    sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Display on Store Website").Value)
    ? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Display on Store Website").Value
    : string.Empty
    </DisplayOnStoreWebsite>
    <product_name_cart expression="true">
    sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "product_name_cart").Value)
    ? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "product_name_cart").Value
    : string.Empty
    </product_name_cart>
    <ConfirmationTemplate expression="true">
    sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Confirmation Template").Value)
    ? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "Confirmation Template").Value
    : string.Empty
    </ConfirmationTemplate>
    <no_addon_configuration_header expression="true">
    sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "cl_addon_header_text").Value)
    ? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "cl_addon_header_text").Value
    : string.Empty
    </no_addon_configuration_header>
    <no_addon_configuration_content expression="true">
    sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "cl_addon_body_text").Value)
    ? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "cl_addon_body_text").Value
    : string.Empty
    </no_addon_configuration_content>
    <is_show_qty_selector expression="true">
    sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "is_show_qty_selector").Value)
    ? (sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "is_show_qty_selector").Value == "True" ? "Yes" : "No" )
    : string.Empty
    </is_show_qty_selector>
    <is_blizz_product expression="true">
    sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "is_blizz_product").Value)
    ? (sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "is_blizz_product").Value == "True" ? "Yes" : "No" )
    : string.Empty
    </is_blizz_product>
    <package_product expression="true">
    sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "package_product").Value)
    ? (sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "package_product").Value == "True" ? "Yes" : "No" )
    : string.Empty
    </package_product>
	<allow_partner_portal expression="true">
    sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "allow_partner_portal").Value)
    ? (sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "allow_partner_portal").Value == "True" ? "Yes" : "No" )
    : string.Empty
    </allow_partner_portal>
    <product_add_button expression="true">sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "product_add_button").Value) ? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "product_add_button").Value : string.Empty</product_add_button>
    <erp_product_description expression="true">sourceObject.CustomAttributes != null &amp;&amp; !string.IsNullOrWhiteSpace(sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "erp_product_description").Value) ? sourceObject.CustomAttributes.FirstOrDefault(att =&gt; att.Key == "erp_product_description").Value : string.Empty</erp_product_description>
    <base_image expression="true">
    sourceObject.ProductImageUrl
    </base_image>
    </item>
    </Items>'
    where SourceEntity = 'ErpCatalog'
