...
set XML = N'<Targets>
  ...
  <Target property="ErpSalesOrder~SalesLines" source-path="//orders/order/product-lineitems/product-lineitem" target-source="ErpSalesLine" repeat="true">
    <Properties>
      ...
      <Target property="ErpSalesLine~LineNumber" source-path="line-number" />
  ...
  <Target property="ErpSalesOrder~TenderLines" source-path="//orders/order/payments/payment" target-source="ErpTenderLine" repeat="true">
    <Properties>
      ...
      <!--Adyen-->
      <Target property="ErpTenderLine~BankIdentificationNumberStart" source-path="BankIdentificationNumberStart" />
      <Target property="ErpTenderLine~ApprovalCode" source-path="ApprovalCode" />
      <Target property="ErpTenderLine~shopperReference" source-path="shopperReference" />
      <Target property="ErpTenderLine~IssuerCountry" source-path="IssuerCountry" />
      <!--SEPA-->
      <Target property="ErpTenderLine~IBAN" source-path="IBAN" />
      <Target property="ErpTenderLine~SwiftCode" source-path="SwiftCode" />
      <Target property="ErpTenderLine~BankName" source-path="BankName" />
      <!--PayPal-->
      ...
      <Target property="ErpTenderLine~ThreeDSecure" source-path="credit-card/three-d" />
      <!--Ending Payment Connector info UY-->
      <!--Allpago Boleto info-->
      <Target property="ErpTenderLine~Boleto" source-path="boleto" target-source="Boleto">
        <Properties>
          <Target property="Boleto~Id" source-path="id" />
          <Target property="Boleto~RegistrationId" source-path="registration-id" />
          <Target property="Boleto~PaymentType" source-path="payment-type" />
          <Target property="Boleto~PaymentBrand" source-path="payment-brand" />
          <Target property="Boleto~Amount" source-path="amount" />
          <Target property="Boleto~Currency" source-path="currency" />
          <Target property="Boleto~Descriptor" source-path="descriptor" />
          <Target property="Boleto~MerchantTransactionId" source-path="merchant-transaction-id" />
          <Target property="Boleto~BuildNumber" source-path="build-number" />
          <Target property="Boleto~Timestamp" source-path="timestamp" />
          <Target property="Boleto~NDC" source-path="ndc" />
          <Target property="Boleto~Result" source-path="result" target-source="BoletoResult">
            <Properties>
              <Target property="Boleto~Code" source-path="code" />
              <Target property="Boleto~Description" source-path="description" />
            </Properties>
          </Target>
          <Target property="Boleto~ResultDetails" source-path="result-details" target-source="BoletoResultDetail">
            <Properties>
              <Target property="Boleto~ExtendedDescription" source-path="extended-description" />
              <Target property="Boleto~ConnectorTxID1" source-path="connector-tx-id1" />
              <Target property="Boleto~MerchantAccount" source-path="merchant-account" />
              <Target property="Boleto~ConnectorInstanceId" source-path="connector-instance-id" />
              <Target property="Boleto~AcquirerReturnCode" source-path="acquirer-return-code" />
              <Target property="Boleto~ConnectorVersion" source-path="connector-version" />
              <Target property="Boleto~AcquirerResponse" source-path="acquirer-response" />
              <Target property="Boleto~EXTERNAL_SYSTEM_LINK" source-path="external-system-link" />
              <Target property="Boleto~ConnectorName" source-path="connector-name" />
              <Target property="Boleto~AcquirerReturnMessage" source-path="acquirer-return-message" />
              <Target property="Boleto~AcquirerTxId1" source-path="acquirer-tx-id1" />
              <Target property="Boleto~AcquirerTxId2" source-path="acquirer-tx-id2" />
            </Properties>
          </Target>
          <Target property="Boleto~Customer" source-path="customer" target-source="BoletoCustomer">
            <Properties>
              <Target property="Boleto~GivenName" source-path="given-name" />
              <Target property="Boleto~Surname" source-path="surname" />
              <Target property="Boleto~MerchantCustomerId" source-path="merchant-customer-id" />
              <Target property="Boleto~Email" source-path="email" />
              <Target property="Boleto~IP" source-path="ip" />
            </Properties>
          </Target>
          <Target property="Boleto~Billing" source-path="billing" target-source="BoletoBilling">
            <Properties>
              <Target property="Boleto~Street1" source-path="street1" />
              <Target property="Boleto~City" source-path="city" />
              <Target property="Boleto~State" source-path="state" />
              <Target property="Boleto~Postcode" source-path="postcode" />
              <Target property="Boleto~Country" source-path="country" />
            </Properties>
          </Target>
          <Target property="Boleto~CustomParameters" source-path="custom-parameters" target-source="BoletoCustomParameter">
            <Properties>
              <Target property="Boleto~Custom_CPF_number" source-path="customer-cpf-number" />
              <Target property="Boleto~Custom_due_date" source-path="custom-due-date" />
              <Target property="Boleto~Merchant_Sitename" source-path="merchant-sitename" />
              <Target property="Boleto~Product" source-path="product" />
            </Properties>
          </Target>
        </Properties>
      </Target>
      <!--End Allpago Boleto info-->
  ...
  <Target property="ErpSalesOrder~CustomAttributes" source-path="//orders/order/custom-attributes/custom-attribute[@attribute-id=''TMVRESELLER'']" default-value="" is-custom-attribute="true" attribute-id="TMVRESELLER" />
  ...
  <Target property="ErpSalesOrder~CustomAttributes" source-path="//orders/order/custom-attributes/custom-attribute[@attribute-id=''TMVLoginEmail'']" default-value="" is-custom-attribute="true" attribute-id="TMVLoginEmail" />
</Targets>'
...
SET		[XML] = N'<Targets>
  ...
  <Target property="ErpSalesOrder~CustomAttributes" source-path="//orders/order/custom-attributes/custom-attribute[@attribute-id=''TMVFraudReviewStatus'']" default-value="" is-custom-attribute="true" attribute-id="TMVFraudReviewStatus" />
  <Target property="ErpSalesOrder~CustomAttributes" source-path="//orders/order/custom-attributes/custom-attribute[@attribute-id=''TMVKountScore'']" default-value="" is-custom-attribute="true" attribute-id="TMVKountScore" />
  <Target property="ErpSalesOrder~CustomAttributes" source-path="//orders/order/custom-attributes/custom-attribute[@attribute-id=''TMVRESELLER'']" default-value="APPLEAPP" is-custom-attribute="true" attribute-id="TMVRESELLER" />
  <Target property="ErpSalesOrder~CustomAttributes" source-path="//orders/order/custom-attributes/custom-attribute[@attribute-id=''TMVINDIRECTCUSTOMEREMAIL'']" default-value="" is-custom-attribute="true" attribute-id="TMVINDIRECTCUSTOMEREMAIL" />
  <Target property="ErpSalesOrder~CustomAttributes" source-path="//orders/order/custom-attributes/custom-attribute[@attribute-id=''TMVTransferOrderAsPerOldDate'']" default-value="0" is-custom-attribute="true" attribute-id="TMVTransferOrderAsPerOldDate" />
  <Target property="ErpSalesOrder~CustomAttributes" source-path="//orders/order/custom-attributes/custom-attribute[@attribute-id=''TMVActivationLinkEmail'']" default-value="" is-custom-attribute="true" attribute-id="TMVActivationLinkEmail" />
  <Target property="ErpSalesOrder~CustomAttributes" source-path="//orders/order/custom-attributes/custom-attribute[@attribute-id=''TMVCustomerReference'']" default-value="" is-custom-attribute="true" attribute-id="TMVCustomerReference" />
