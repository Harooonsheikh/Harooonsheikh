...
namespace VSI.CommerceLink.MagentoAdapter.Controllers
{
    ...
    public class CustomerController : BaseController, ICustomerController
    {
        ...
        public CustomerController(string storeKey) : base(false, storeKey)
        {
            ...
            this.xmlHelper = new XmlTemplateHelper(StoreService.GetStoreByKey(storeKey));
        }
        ...
        public void UpdateCustomer(List<EcomcustomerCustomerEntity> customer)
        {
            ...
            try
            {
                ...
                string fileNameCustomer = Path.Combine(configurationHelper.GetSetting(CUSTOMER.Local_Output_Path), "Updated Customer-" + currentStore.Name + "-" + DateTime.UtcNow.ToString("yyyyMMddhhmmssfff") + ".csv");
        ...
        public void UpdateCustomerViaXML(List<EcomcustomerCustomerEntity> customers)
        {
            try
            {
                ...
                foreach (var cus in customers)
                {
                    ...
                    string fileNameCustomer = "Updated Customer-" + cus.customer_id + "-" + currentStore.Name + "-" + DateTime.UtcNow.ToString("yyyyMMddhhmmssfff") + ".xml";
        ...
        public void UpdateAddress(List<EcomcustomerAddressEntityItem> customer)
        {
            ...
            try
            {
                ...
                string fileNameAddress = Path.Combine(configurationHelper.GetSetting(CUSTOMER.Address_Local_Output_Path), "Updated Address-" + currentStore.Name + "-" + DateTime.UtcNow.ToString("yyyyMMddhhmmssfff") + ".csv");
