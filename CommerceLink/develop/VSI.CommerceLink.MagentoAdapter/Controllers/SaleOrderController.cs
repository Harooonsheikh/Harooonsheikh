    ...
    public class SaleOrderController : BaseController, ISaleOrderController
    {
        ...
        public ErpSalesOrder GetSalesOrders(string localFile)
        {
            ...
            try
            {
                ...
                if (System.Configuration.ConfigurationManager.AppSettings["IsLoadFromDatabase"] != null && System.Configuration.ConfigurationManager.AppSettings["IsLoadFromDatabase"] == "1")
                    xmlHelper.GenerateObjectByTemplateFromDatabase(localFile, XmlTemplateHelper.XmlSourceDirection.READ, order);
                else
                    xmlHelper.GenerateObjectByTemplateFromFile(localFile, XmlTemplateHelper.XmlSourceDirection.READ, order);
            }
            catch (Exception ex)
            {
