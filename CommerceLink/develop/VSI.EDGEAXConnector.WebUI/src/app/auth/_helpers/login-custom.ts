export class LoginCustom {
    ...
    static displayChangePasswordForm() {
        ...
        (<any>login.find('.m-login__change-password')).show();
        (<any>login.find('.m-login__signin')).animateClass('flipOutX animated');
        (<any>login.find('.m-login__signin')).hide();
        (<any>login.find('.m-login__change-password')).animateClass('flipInX animated');
    }
    ...
    static displaySignInForm() {
        ...
        (<any>login.find('.m-login__change-password')).hide();
        login.addClass('m-login--signin');
        (<any>login.find('.m-login__signin')).show();
